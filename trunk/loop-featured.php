		...
		<div id="featured-<?php the_ID(); ?>" <?php post_class('clearfix featured-post'); ?>>
			...
			<div class="featured-entry-body">
				<div class="featured-entry-header">
					...
					<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'stf' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="read-more block small">READ MORE</a>
				</div>
			</div>
		</div>
		<!-- [End] Post -->
